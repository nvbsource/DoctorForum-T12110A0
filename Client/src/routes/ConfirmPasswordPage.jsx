...
export default function ConfirmPasswordPage() {
   ...
   const handleSubmit = values => {
      const { passwordnew, password } = values;
      dispatch(loginStart({ passwordnew, password }));
   };
         ...
         <div className="flex flex-row bg-white rounded-xl truncate">
            ...
            <div className="flex flex-col justify-center p-3 mb-10 sm:items-center flex-3">
               ...
               <div className="flex flex-col gap-y-[12px] form_signin">
                  <h2 className="sm:text-xl text-base  font-black text-[#373737] m-auto">Confirm Change Password</h2>
                  <Form
                     name="basic"
                     labelCol={{ span: 8 }}
                     wrapperCol={{ span: 24 }}
